...
function getBackupKeywords(category: string = "all"): string[] {
  ...
  // 2025.03.18 데이터랩 쇼핑인사이트에서 확인된 실제 인기 키워드
  const categoryKeywords: Record<string, string[]> = {
    ...
    fashion: [
      "투명안경테", "원피스", "투명사무실", "팔레스", "무지", 
      "가죽지갑", "스텐리스락", "폴리스", "awehyu31030", "시소이즈벳터"
    ],
    accessory: [
      "투명안경테", "가죽지갑", "나이키운동화", "호카", "백팩", 
      "크로스백", "운동화", "샌들", "미니백", "워커"
    ],
    beauty: [
      "팔레스", "립밤", "마스카라", "쿠션", "틴트",
    ...
    food: [
      "닭가슴살", "당근", "쭈꾸미", "파로효소", "바밤바", 
      "쌀", "커피", "코코아", "콩나물", "떡볶이"
    ],
    sports: [
      "나이키운동화", "호카", "무지", "레깅스", "테니스", 
