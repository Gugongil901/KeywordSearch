...
function getBackupKeywords(category: string = "all"): string[] {
  ...
  const categoryKeywords: Record<string, string[]> = {
    all: [
      "투명안경테", "원피스", "투명사무실", "햄스터", "팔레스", 
      "가죽지갑", "무지", "스텐리스락", "메이차", "anotheryouth"
    ],
    fashion: [
      "투명안경테", "원피스", "투명사무실", "가죽지갑", "팔레스", 
      "anotheryouth", "올젠", "셔츠", "플리츠", "후드티"
    ],
    accessory: [
      "투명안경테", "가죽지갑", "스니커즈", "슬링백", "백팩", 
      "크로스백", "운동화", "샌들", "미니백", "워커"
    ],
    beauty: [
      "팔레스", "립밤", "마스카라", "쿠션", "틴트",
      "미스트", "선크림", "파운데이션", "시카크림", "마스크팩"
    ],
    digital: [
      "awehyu31030", "갤럭시", "아이폰", "맥북", "에어팟", 
      "노트북", "스마트워치", "갤럭시버즈", "태블릿", "블루투스이어폰"
    ],
    furniture: [
      "투명사무실", "스텐리스락", "책상", "침대", "소파", 
      "매트리스", "식탁", "의자", "서랍장", "행거"
    ],
    baby: [
      "아이소이붐붐젤", "무지", "젖병", "기저귀", "분유", 
      "유모차", "아기옷", "물티슈", "카시트", "장난감"
    ],
    food: [
      "메이차", "과일", "견과류", "햄스터", "바밤바", 
